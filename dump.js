...
/*
Code which genrated canavas o the go instead of converting each from from domtonode
the genrated canavs was filled with incremting text
but the  text was printed out in desired manner
*/
import React, {Component, Fragment} from 'react';
import AceEditor from 'react-ace';;
